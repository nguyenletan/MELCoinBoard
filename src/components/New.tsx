    ...
    return (
        <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <ButtonBase style={{ textAlign: 'left' }} href={newz.link} target={"_blank"}>
                <Card sx={{ width: 300, height: 350 }} style={{overflow: "auto", paddingBottom: "20px"}}>
                    <CardMedia
                        component="img"
                        height="180"
                        image={newz.media || ""}
                        alt=""
                    />
                    <CardContent style={{ paddingBottom: "0", paddingTop: "10px", textOverflow: "ellipsis", overflow: "hidden" }}>
